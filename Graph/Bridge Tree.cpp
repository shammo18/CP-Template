...
// Problem : light oj 1291
// Solution : we can pair up the leaves in the bridge tree. ceil( #leaves / 2).
...
vector<int> tree[N],graph[N];//edge list representation of graph
